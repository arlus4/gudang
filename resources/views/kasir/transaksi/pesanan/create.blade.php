        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li>
                        <a class="parent-item" href="/kasir/transaksi">Daftar Transaksi</a>&nbsp;
                        <i class="fa fa-angle-right"></i>
                    </li>
                                    ...
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>@currency($harga->harga_retail)</td>
                                                <td>{{ $harga->produk_stok->jumlah_produk }}</td>
                                                <td>
                                                    <form class="d-inline" action="{{ url('/kasir/transaksi/create/addproduct', $harga->id) }}" method="post">
                                                        @csrf
                            ...
                            <div class="card-body " id="bar-parent">
                                <div class="table-scrollable">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <form action="/kasir/transaksi/create/clear" method="post">
                                                    @csrf
                                                ...
                                                <td>{{Str::words($item['name'],3)}} <br>
                                                    Rp. {{ number_format($item['harga_retail'],2,',','.') }}
                                                </td>
                                                <td class="font-weight-bold">
                                                    <form action="{{ url('/kasir/transaksi/create/tambah', $item['produkId']) }}" method="POST">
                                                        @csrf
                                ...
                                <div class="profile-userbuttons">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <form action="/kasir/transaksi/create/clear" method="POST" class="d-inline">
                                                @csrf
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="/kasir/transaksi/create/bayar" method="POST">
                                                    @csrf
