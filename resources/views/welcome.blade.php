...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('assets/plugins/iconic/css/material-design-iconic-font.min.css') }}" rel="stylesheet" />
            ...
            <div class="container-login100 page-background">
                <div class="wrap-login100">
                    ...
                    <form class="form-404">
                        ...
                        <p class="content-404">Anda Sudah Login</p>
                            <div class="container-login100-form-btn">
                                <a href="{{ url('/admin/dashboard') }}" class="login100-form-btn">
                                    Kembali ke Beranda
                                </a>
                            </div>
                        @else
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                {{-- <a href="#" type="button" class="btn btn-circle btn-md btn-default ">
                                    <i class="fa fa-user-o"></i> Konsumen
                                </a> --}}
                                {{-- <a href="{{ route('admin.login') }}" type="button" class="btn btn-circle btn-md btn-default ">
                                    <i class="fa fa-user-circle-o"></i> Admin
                                </a>
                                <a href="{{ route('pegawai.login') }}" type="button" class="btn btn-circle btn-md btn-default ">
                                    <i class="fa fa-user-circle-o"></i> Pegawai
                                </a>
                                <a href="{{ route('pelanggan.login') }}" type="button" class="btn btn-circle btn-md btn-default ">
