    ...
    <div class="page-content">
        ...
        <div class="row">
                ...
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" value="({{ $pelanggan->kasirs->kode }}) {{ $pelanggan->kasirs->nama }}" class="form-control" readonly disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 control-label">Kategori Pelanggan</label>
                            <div class="col-sm-12">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="card card-box">
                    <div class="card-head">
                        <header>Reward Pelanggan</header>
                    </div>
                    <div class="card-body " id="bar-parent6">
